...
* Check the `ConnectionStrings` in `appsettings.json` file under the `SelfHostApp` project and change it if you need.
...
* `SelfHostApp`: ASP.NET Core API host application.
...
> `fdc9de61-f3be-4d9e-a9d8-ea94e2779ed8` is the password of the certificate, you can change it to any password you want.
