...
using SelfHostApp.HealthChecks;
...
public class SelfHostAppModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("SelfHostApp");
    ...
    {
        context.Services.AddSelfHostAppHealthChecks();
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<SelfHostAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/SelfHostApp");

            options.DefaultResourceType = typeof(SelfHostAppResource);
        ...
        {
            options.MapCodeNamespace("SelfHostApp", typeof(SelfHostAppResource));
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(SelfHostAppModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"SelfHostApp", "SelfHostApp API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "SelfHostApp API", Version = "v1" });
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("SelfHostApp");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<SelfHostAppModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<SelfHostAppModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<SelfHostAppDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "SelfHostApp API");
