...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "SelfHostApp", 
            DisplayName = "SelfHostApp API", 
            Resources = { "SelfHostApp" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Angular Client
        var consoleAndAngularClientId = configurationSection["SelfHostApp_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["SelfHostApp_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["SelfHostApp_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["SelfHostApp_Swagger:RootUrl"].TrimEnd('/');
